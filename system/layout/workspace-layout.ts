...
export const DETAIL_TILE_LIBRARY_PANEL_MIN_WIDTH = 240;
export const DETAIL_TILE_LIBRARY_PANEL_MAX_WIDTH = 420;
export const DETAIL_TILE_LIBRARY_PANEL_DEFAULT_WIDTH = 280;

export const DETAIL_TILE_PROPERTIES_PANEL_MIN_WIDTH = 240;
export const DETAIL_TILE_PROPERTIES_PANEL_MAX_WIDTH = 420;
export const DETAIL_TILE_PROPERTIES_PANEL_DEFAULT_WIDTH = 280;
